...
server <- function(input, output,session) {
  ...
  if(file.exists(paste0("CWdata/",locFile4Attempt))){
    ...
    dateSeries = seq(from=ymd_hms("2017-01-01 01:00:00", tz= 'GMT'),to=CWdataFull$created_at[nrow(CWdataFull)]+3600,by='1 day')
  ...
  dateSeriesTS = seq(from=min(ymd_hms("2017-01-01 01:00:00", tz= 'GMT')),to=max(uq.datesTS)+3600,by='1 day')
  ...
  dateSeriesSM = seq(from=min(ymd_hms("2017-01-01 01:00:00", tz= 'GMT')),to=max(uq.datesSM)+3600,by='1 day')
  ...
  dateSeriesPP = seq(from=min(ymd_hms("2017-01-01 01:00:00", tz= 'GMT')),to=max(uq.datesPP)+3600,by='1 day')
  ...
  dateSeriesWL = seq(from=min(ymd_hms("2017-01-01 01:00:00", tz= 'GMT')),to=max(uq.datesWL)+3600,by='1 day')
  ...
  dateSeriesPS = seq(from=min(ymd_hms("2017-01-01 01:00:00", tz= 'GMT')),to=max(uq.datesPS)+3600,by='1 day')
  ...
  dateSeriesST = seq(from=min(ymd_hms("2017-01-01 01:00:00", tz= 'GMT')),to=max(uq.datesST)+3600,by='1 day')
